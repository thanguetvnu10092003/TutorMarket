  ...
  return (
    ...
    >
      <div className="page-container">
            ...
            <div className="hidden md:flex items-center gap-1">
              {visibleNavLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className={`px-4 py-2 rounded-lg relative text-sm font-medium transition-colors duration-200 ${
                    pathname === link.href
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            {isStudent && (
              <div className="relative">
                ...
                >
                  <Heart size={20} fill={favoriteTutors.length > 0 ? 'currentColor' : 'none'} />
                ...
                {showFavorites && (
                  <div className="absolute right-0 top-full mt-2 w-80 bg-white dark:bg-navy-500 rounded-2xl shadow-glass-lg border border-navy-100 dark:border-navy-400 animate-scale-in origin-top-right overflow-hidden">
            ...
            {session ? (
              <div className="relative">
                ...
                >
                  ...
                  <div className="w-8 h-8 rounded-full bg-gold-400 flex items-center justify-center text-navy-600 text-xs font-bold overflow-hidden border-2 border-gold-200 dark:border-navy-400 ring-2 ring-gold-400/30 hover:ring-gold-400/60 transition-all duration-200">
                    {session.user?.image ? (
                ...
                {showUserMenu && (
                  <div className="absolute right-0 top-full mt-2 w-56 bg-white dark:bg-navy-500 rounded-2xl shadow-glass-lg border border-navy-100 dark:border-navy-400 overflow-hidden animate-scale-in origin-top-right">
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden pb-6 animate-slide-down z-50 relative">
            {!pathname.startsWith('/dashboard') && (
